...
Os scripts auxiliares \codefile{run\_atp.py}, \codefile{simulate\_direct.py} e \codefile{save\_images.py} servem como ponte com o caso ATP e com visualizações adicionais. \codefile{run\_atp.py} tenta executar o ATP, ler o arquivo binário \codefile{.pl4} e gerar gráficos Plotly. \codefile{simulate\_direct.py} implementa diretamente a escada Pi de 20 seções equivalente ao ATP, enquanto \codefile{save\_images.py} salva imagens PNG da resposta por nós selecionados.
