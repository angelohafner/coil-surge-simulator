...
Além do caso aberto, o simulador também executa um cenário Pi com terminação aterrada. Nesse cenário, a fonte de surto fica entre o nó de referência e a entrada da bobina, enquanto o terminal final da bobina retorna diretamente ao nó de referência. Essa condição prende a tensão do terminal final em \SI{0}{V} e serve como contraste didático para mostrar como a condição de contorno altera a reflexão e a distribuição interna de tensão.
